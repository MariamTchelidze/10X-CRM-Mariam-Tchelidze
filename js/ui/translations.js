  ...
  const translations = {
    ...
    ka: {
      ...
      text: {
        ...
        "Delete this demo account and all CRM data saved in this browser.": "წაშალეთ ეს დემო ანგარიში და ამ ბრაუზერში შენახული ყველა CRM მონაცემი.",
        ...
        "This action permanently clears the demo account, session, clients, profile image, tasks, notifications, settings, and theme preferences stored in this browser.": "ეს მოქმედება სამუდამოდ გაასუფთავებს ამ ბრაუზერში შენახულ დემო ანგარიშს, სესიას, კლიენტებს, პროფილის სურათს, დავალებებს, შეტყობინებებს, პარამეტრებს და თემის არჩევანს.",
        ...
        "Mark all read": "ყველა წაკითხულის მონიშვნა",
        ...
        "Call Alpha Group": "Alpha Group-თან დარეკვა",
        "Text SMS": "SMS ტექსტი",
        "WhatsApp": "WhatsApp",
        "Application Phone": "აპლიკაციის ტელეფონი",
        "10X CRM Phone": "10X CRM ტელეფონი",
        "Demo dialer is call-ready, but real calling is disabled from configuration.": "დემო დამრეკი მზადაა, მაგრამ რეალური ზარები კონფიგურაციაში გამორთულია.",
